const CONFIG = {
  ...
  resume: {
    fileUrl: 'https://raw.githubusercontent.com/HARISH-B-2001/HARISH-BALAKRISHNAN-2001.github.io/refs/heads/main/src/resume/Harish_Balakrishnan_Resume.pdf', // Replace with the actual file URL or leave empty to hide the button.
  },
  skills: [
    'Python',
    'Java',
